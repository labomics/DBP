...
dim_plot <- function(obj, w, h, reduction = NULL, split.by = NULL, group.by = NULL,
    ...
    border = F, raster = T, rater_dpi = 512) {
...
# col_40 <- c("#8b4513", "#6b8e23", "#483d8b", "#bc8f8f", "#008080", "#000080", "#daa520", "#8fbc8f", "#8b008b",
...
#             "#5f8f5d", "#75938d", "#3ed0cd", "#e9b9ea", "#6e724b", "#7b7be0", "#807353", "#8db249", "#422742",
#             "#a38c2e", "#152d18", "#0b87a9", "#177646")
# col_36 <- c("#8b4513", "#6b8e23", "#483d8b", "#bc8f8f", "#008080", "#000080", "#daa520", "#8fbc8f", "#8b008b",
#             "#b03060", "#ff0000", "#00ff00", "#00fa9a", "#8a2be2", "#dc143c", "#00ffff", "#00bfff", "#0000ff",
#             "#adff2f", "#ff7f50", "#ff00ff", "#1e90ff", "#f0e68c", "#ffff54", "#add8e6", "#ff1493", "#ee82ee",
#             "#5f8f5d", "#75938d", "#3ed0cd", "#e9b9ea", "#6e724b", "#7b7be0", "#807353", "#8db249", "#422742")
...
# col_13 <- c("#8FC36D", "#f54646", "#4472c4", "#fff300", "#ff69b4", "#ff00ff", "#14e6e6", "#008000", "#82B4ed",  "#D4aaff",
#             "#eee8aa", "#2f4f4f", "#ad6800")
# col_18 <- c("#8FC36D", "#f54646", "#4472c4", "#fff300", "#ff69b4", "#ff00ff", "#14e6e6", "#008000", "#82B4ed",  "#D4aaff", 
#             "#eee8aa", "#2f4f4f", "#796548", "#f54646", "#482eb0", "#48552a", "#135504", "#450546")
...
col_5  <- c("#459145", "#b37575", "#4e4e8f", "#5d869f", "#644363")

col_8 <- c("#729e54", "#c25151", "#355fa9", "#891d89", "#5f8dc1", "#8f74ab", "#008000", "#807b21")

col_14 <- c("#729e54", "#c25151", "#355fa9", "#891d89", "#5f8dc1", "#8f74ab", "#008000", "#807b21", "#54609e", "#847139",
            "#8c9e54", "#bc51c2", "#a97735", "#2f8f94")

col_16 <- c("#76a059", "#b36e6e", "#6e8cc0", "#d9d587", "#d6a6be", "#c981c9", "#92bcbc", "#759e75", "#6f9bbc",  "#9a79bb", 
            "#8e8b61", "#2f4f4f", "#796548", "#d46969", "#615495", "#48552a")

col_28 <- c("#76a059", "#b36e6e", "#6e8cc0", "#d9d587", "#d6a6be", "#c981c9", "#779999", "#759e75", "#85afcf", "#9a79bb", 
            "#8e8b61", "#2f4f4f", "#796548", "#d46969", "#615495", "#48552a", "#2e4a54", "#1b1b9b", "#aa5c40", "#cd5fcd",
            "#3d6995", "#bab47a", "#81b7c9", "#7d2c57", "#9c589c", "#7bb079", "#5a3a5a", "#398a89")

col_31 <- c("#8b4513", "#6b8e23", "#483d8b", "#bc8f8f", "#008080", "#000080", "#daa520", "#8fbc8f", "#8b008b", "#b03060", 
            "#ff0000", "#807353", "#8db249", "#8a2be2", "#b22541", "#69aaaa", "#00bfff", "#0000ff", "#ff7f50", "#ff00ff",
            "#1e90ff", "#f0e68c", "#add8e6", "#851c54", "#ee82ee", "#5f8f5d", "#422742", "#3ed0cd", "#e9b9ea", "#6e724b",
            "#3a6c25")
...
dim_reduc <- function(obj, rna = "rna") {
    ...
    obj <-  NormalizeData(obj) %>%
            # FindVariableFeatures(nfeatures = 2000) %>%
            ScaleData() %>%
            RunPCA(reduction.name = "pca_rna", verbose = F, npcs = 50)
