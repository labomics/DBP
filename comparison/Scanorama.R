...
parser$add_argument("--method", type = "character", default = "scanorama_embed")
...
# rna
integrated.rna <- scanorama$integrate(rna_assay_list, rna_gene_list, dimred = as.integer(K))
...
# %%
write.csv(scanorama_rna, pj(output_dir, "embeddings.csv"))

# %% [markdown]
# ## Visualization

# %%
obj <- RunUMAP(obj, reduction = "scanorama_rna", dims = 1:K, reduction.name = "umap")
